...
const createCommentsMarkup = (comment) => {
  ...
  let dateString = defineCommentDate(date);
  return (`<li class="film-details__comment">
            <span class="film-details__comment-emoji">
              <img src=".${emote}" width="55" height="55" alt="emoji-angry">
            </span>
            <div>
...
const createFilmDetails = (film) => {
  ...
  const writersMarkup = writers.join(`, `);
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${releaseDate.getDate()} ${getMonthInText(releaseDate)} ${releaseDate.getFullYear()}</td>
            </tr>
            <tr class="film-details__row">
